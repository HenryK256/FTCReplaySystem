...
Recorder
  ...
  5. Once you have finished recording, press the Share and X buttons on the gamepad1 simultaneously. The Share button will be different for each controller, but it should be       one       of the menu buttons not commonly used.
  6. The file with the data will be saved automatically, and requestOpModeStop() is used to end the program.
...
Replayer
  ...
  5. The autonomous function will stop automatically after finishing the sequence.
